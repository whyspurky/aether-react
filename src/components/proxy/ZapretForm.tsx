...
type ZapretStatus = 'unknown' | 'running' | 'stopped' | 'not_installed';
...
interface Props {
  ...
  onStatusChange: (status: ZapretStatus) => void;
}

export function ZapretForm({ batPath, status, folder, onChangeBatPath, onStatusChange }: Props) {
